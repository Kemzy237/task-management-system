...
<body>
	...
	<?php include "inc/nav-admin.php"; ?>
		<section class="section-1">
			<h4 class="title">Edit User  <a href="user-department.php">Users</a></h4>
            <form class="form-1" method="POST" action="app/update-user-department.php">
            ...
            <?php }?>
                ...
                <div class="form-floating mb-3 input-holder">
                    <input type="text" id="username" class="form-control input-1" value="<?=$user['username']?>" name="user_name" placeholder="Username"><br>
                ...
                <div class="form-floating mb-3 input-holder">
                    <input type="text" id="contact" class="form-control input-1" name="contact" placeholder="contact" value="<?=$user['contact']?>"><br>
                    <label for="contact"><i class="fas fa-address-book"></i>Contact</label>
                </div>
                <input type="text" name="department" value="<?=$user['department']?>" hidden>
